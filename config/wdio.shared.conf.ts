...
/**
 * All not needed configurations, for this template, are removed.
...
export const config: WebdriverIO.Config = {
    ...
    afterTest: async (test, context: any, result): Promise<void> => {
        if (!result.passed) {
            await driver.takeScreenshot();
            allureReporter.addAttachment("Error:", result.error, "text/plain");
        }
    },
};
